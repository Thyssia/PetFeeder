		...
		<div class="reg-div1" align="center">
			...
			<form action="<%=request.getContextPath()%>/register" method="post">
				<table class="table1" style="with: 80%">
					<tr>
						<td>First Name</td>
						<td><input class="tomato-input" type="text" name="firstName"
							required="required" /></td>
					</tr>
					<tr>
						<td>Last Name</td>
						<td><input class="tomato-input" type="text" name="lastName"
							required="required" /></td>
					</tr>
					<tr>
						<td>Email</td>
						<td><input class="tomato-input" type="text" name="email"
							required="required" /></td>
					</tr>
					<tr>
						<td>Username</td>
						<td><input class="tomato-input" type="text" name="username"
							required="required" /></td>
					</tr>
					<tr>
						<td>Password</td>
						<td><input class="tomato-input" type="password"
			...
			<p>
				<i>If you don't have an account, please make one now with this
					form. </i>
			<p>
			<p>PetFeeder will send you email notifications as well as display
