...
%><br>
			...
			<form class=form-label
				action="<%=request.getContextPath()%>/DogServlet?action=insert"
				method="post">
				Dog name: <input class=newdog-div type="text" name="dogName" /> <br>
				<br> Dog size: <select class=new-dog-select name="dogType">
					<option value="small">Small</option>
					<option value="medium">Medium</option>
					<option value="large">Large</option>
				</select> <input type="hidden" name="owner" value="<%=user%>"> <br>
				<br> <br> <input class=yet-another-submit-btn
					type="submit" value="Submit" />
			</form>
			<br> <br>
		</div>
		<img style="padding: 27px" src="./Images/doggo.png"
			alt="small-dog-clipart1" />
	</body>
</div>
</html>
