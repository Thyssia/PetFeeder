...
<html>
	...
	<div id=wrapper>
		...
		rgba(255, 255, 255, .1) 3px, transparent 3px, transparent 60px), 
		repeating-linear-gradient(60deg, rgba(255, 255, 255, .1), rgba(255, 255, 255, .1) 1px, 
		transparent 3px, transparent 60px), linear-gradient(60deg, rgba(139, 139, 139, .6) 25%, 
		transparent 25%, transparent 75%, rgba(139, 139, 139, .6) 75%, rgba(139, 139, 139, .6)), 
		linear-gradient(120deg, rgba(139, 139, 139, .6) 25%, transparent 25%, 
		transparent 75%, rgba(139, 0, 139, .6) 75%, rgba(76, 40, 220, .6)); 
		...
		<div class="index-welcome-login" align="center">
			...
			<div class="inner-login-div">
				...
				<p>First time here?
				<p>
					<a style="color: magenta" href="user?action=REGISTER">
						<i>Register Here</i>
					</a> 
				<br>
			</div>
